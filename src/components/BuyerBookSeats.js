        ...
        <Container maxWidth="md">
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={12}>
                    <TextField fullWidth type="number" id="standard-basic" label="Enter a Show Number"
                               variant="standard"
                               value={buyShowNumber} onChange={e => setBuyShowNumber(e.target.value)}/>
                </Grid>

                {buyIsError && <small className="mt-3 d-inline-block text-danger">Something went wrong. Please try again
                    later.</small>}
                ...
                <Grid item xs={12} sm={12}>
                    <TextField fullWidth type="text" id="standard-basic" label="Seats you wish to book"
                               variant="standard"
